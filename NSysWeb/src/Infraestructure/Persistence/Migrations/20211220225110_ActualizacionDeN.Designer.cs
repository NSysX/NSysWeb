...
namespace Persistence.Migrations
{
    ...
    [Migration("20211220225110_ActualizacionDeN")]
    partial class ActualizacionDeN
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Asentamiento", b =>
                {
                    ...
                    b.Property<int>("AsentamientoTipoId")
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "AsentamientoTipoId" }, "IXFK_Asentamiento_AsentamientoTipo");

                    b.HasIndex(new[] { "MunicipioId", "AsentamientoTipoId", "Nombre" }, "IX_NoDuplicado")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Entities.Documento", b =>
                {
                    ...
                    b.HasIndex(new[] { "DocumentoTipoId" }, "IXFK_Documento_DocumentoTipo");
            ...
            modelBuilder.Entity("Domain.Entities.Persona", b =>
                {
                    ...
                    b.HasIndex(new[] { "EstadoCivilId" }, "IXFK_Persona_EstadoCivil");

                    b.HasIndex(new[] { "NacionalidadId" }, "IXFK_Persona_Nacionalidad");
            ...
            modelBuilder.Entity("Domain.Entities.Asentamiento", b =>
                {
                    b.HasOne("Domain.Entities.AsentamientoTipo", "AsentamientoTipoIdNavigation")
                        .WithMany("Asentamientos")
                        .HasForeignKey("AsentamientoTipoId")
                        .HasConstraintName("FK_Asentamiento_AsentamientoTipo")
                        .IsRequired();

                    b.Navigation("AsentamientoTipoIdNavigation");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Documento", b =>
                {
                    b.HasOne("Domain.Entities.DocumentoTipo", "DocumentoTipoIdNavigation")
                        .WithMany("Documentos")
                        .HasForeignKey("DocumentoTipoId")
                        .HasConstraintName("FK_Documento_DocumentoTipo")
                        .IsRequired();

                    b.Navigation("DocumentoTipoIdNavigation");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Persona", b =>
                {
                    b.HasOne("Domain.Entities.EstadoCivil", "EstadoCivilIdNavigation")
                        .WithMany("Personas")
                        .HasForeignKey("EstadoCivilId")
                        .HasConstraintName("FK_Persona_EstadoCivil")
                        .IsRequired();

                    b.HasOne("Domain.Entities.Nacionalidad", "NacionalidadIdNavigation")
                        .WithMany("Personas")
                        .HasForeignKey("NacionalidadId")
                        .HasConstraintName("FK_Persona_Nacionalidad")
                        .IsRequired();

                    b.Navigation("EstadoCivilIdNavigation");

                    b.Navigation("NacionalidadIdNavigation");
                });

            modelBuilder.Entity("Domain.Entities.PersonaCorreoElectronico", b =>
                {
                    b.HasOne("Domain.Entities.CorreoElectronico", "IdCorreoElectronicoNavigation")
                        .WithMany()
                    ...
                    b.Navigation("IdCorreoElectronicoNavigation");
            ...
            modelBuilder.Entity("Domain.Entities.PersonaDocumento", b =>
                {
                    b.HasOne("Domain.Entities.Documento", "IdDocumentoNavigation")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.PersonaTelefono", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Telefono", "IdTelefonoNavigation")
                        .WithMany()
                    ...
                    b.Navigation("IdTelefonoNavigation");
                });
