...
{
    public class InsertaNacionalidadCommand : IRequest<Respuesta<int>>
    {
        public string Estatus { get; set; }
        public string Descripcion { get; set; }
    }

    public class InsertaNacionalidad_Manejador : IRequestHandler<InsertaNacionalidadCommand, Respuesta<int>>
    {
        ...
        public async Task<Respuesta<int>> Handle(InsertaNacionalidadCommand request, CancellationToken cancellationToken)
        {
