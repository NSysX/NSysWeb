...
{
    public class ActualizaNacionalidadCommand : IRequest<Respuesta<int>>
    {
    ...
    public class ActualizaNacionalidad_Manejador : IRequestHandler<ActualizaNacionalidadCommand, Respuesta<int>>
    {
        ...
        public async Task<Respuesta<int>> Handle(ActualizaNacionalidadCommand request, CancellationToken cancellationToken)
        {
